##
# @file PyPSACalculatorOptimize.py
#
# @brief PyPSA Linear Optimal Power Flow calculations.
#
# @section libraries_PyPSACalculatorOptimize Libraries/Modules
# - pypsa
##
...
class PyPSACalculatorOptimize (PyPSANetworkBuilder):
    """
    ...
    def calculate(self) -> bool:
        ...
        succes: bool = True
        status = self._pypsa_model.optimize()
