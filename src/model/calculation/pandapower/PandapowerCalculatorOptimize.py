...
class PandapowerCalculatorOptimize(PandapowerNetworkBuilder):
    ...
    def calculate(self) -> bool:
        ...
        #         print("         Cannot run optimization on empty grid - treating as successful.")
        #         self._calculation_time = time.perf_counter() - start_time
        ...
        if not has_generators and not has_storage:
            print("INFO: No generators or storage units for optimization.")
            print("      This is typically because no physical modules are placed on the table.")
            print("      Skipping optimization and treating as successful empty grid.")
            self._calculation_time = time.perf_counter() - start_time
            self._status = "warning" 
        ...
        try:
            ...
            print(f"Error during optimal power flow: {e}")
            success = False            
        
        if success:
            print("Retrieving optimization results...")
