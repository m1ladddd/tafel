...
# - Modified by Thijs Meidam on 07/05/2023.
##

import paho.mqtt.client as mqtt
import json

class Prototype_MQTT:
    """! 
    Provides access to the connected MQTT broker sensor.
    This connection manages the communication between this program and the the module prototypes
    """
    ...
    def __init__(self):
        ...
        self.__mqtt_subscribe = self.__mqtt_topic + "/Module"
        ## MQTT publish topic.
