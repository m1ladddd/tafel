...
# - Modified by Thijs Meidam on 29/05/2023.
##
...
class Jupyter_MQTT:
    ...
    This connection manages the communication between this program and the jupyter apps
    """
    ...
    def __init__(self):
        ...
        ## MQTT base topic.
        self.__mqtt_topic = "SmartDemoTable2"

        ## Port to use (1883 = default).
        self.__mqtt_port = 1883

        ## MQTT subscribe topic.
        self.__mqtt_subscribe = self.__mqtt_topic + "/Jupyter/Ingoing"
        ## MQTT publish topic.
        self.__mqtt_publish = self.__mqtt_topic + "/Jupyter/Outgoing"
    ...
    def on_connect(self, client, userdata, flags, rc):
        ...
        if(rc != 0):
            print("Prototype: Error: " + str(rc))
        else:
            self.__mqtt_connected = True
            print("Prototype: Succesfully started Prototype MQTT client")
